...
While looking for a good solder fume extractor online, I found that many of the cheap solder fume extractors sold online don't effectively remove the harmful particles created from soldering. These fume extractors often only feature an activiated carbon filter, making them ineffective at removing a lot of the harmful particles associated with soldering. Activated carbon is great at removing the smell associated with soldering, but falls flat when filtering out the smaller harmful particles. Other than the filter media, there's also no guarantee of the strength of the fan, or lifetime of the filter. Once either of those die theres no telling how costly or hard it will be to replace. 
